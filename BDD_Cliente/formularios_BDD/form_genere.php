...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Crear instancia de la clase Género y realizar la inserción
...
<div class="container">
    <h2 class="mt-4 text-center">Formulario de Género</h2>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
        <div class="form-group">
            <label for="nom"><i class="fas fa-list"></i> Género:</label>
            <input type="text" class="form-control" name="nom" placeholder="Ingrese el nombre del género" required>
        </div>
