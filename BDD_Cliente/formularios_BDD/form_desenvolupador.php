...
<head>
    ...
    <title>Formulario de Desarrollador</title>
...
<div class="container">
    <h2 class="mt-4 text-center">Formulario de Desarrollador</h2>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
        <div class="form-group">
            <label for="nom"><i class="fas fa-user"></i> Desarrollador:</label>
            <input type="text" class="form-control" name="nom" placeholder="Ingrese el nombre del desarrollador" required>
        </div>
